...
/*
 *       AP_Compass_IMX6S.cpp - Arduino Library for IMX6S magnetometer
 *
 */
...
// constructor
AP_Compass_IMX6S::AP_Compass_IMX6S(Compass &compass):
...
// detect the sensor
AP_Compass_Backend *AP_Compass_IMX6S::detect(Compass &compass)
{
    AP_Compass_IMX6S *sensor = new AP_Compass_IMX6S(compass);
    if (sensor == NULL) {
        return NULL;
    }
    if (!sensor->init()) {
...
bool AP_Compass_IMX6S::init(void)
{
...
void AP_Compass_IMX6S::read(void)
{
...
void AP_Compass_IMX6S::accumulate(void)
{
