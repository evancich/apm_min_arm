...
#ifndef AP_Compass_IMX6S_H
#define AP_Compass_IMX6S_H

#include "Compass.h"
#include "AP_Compass_Backend.h"

class AP_Compass_IMX6S : public AP_Compass_Backend
{
public:
    bool        init(void);
    void        read(void);
    ...
    AP_Compass_IMX6S(Compass &compass);
    // detect the sensor
